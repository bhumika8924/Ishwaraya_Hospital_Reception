"""
Combined reception counter app.

Uses the Streamlit receptionist counter flow from app.py and adds the saved
two-line visitor counter in the same video analysis.
"""
